...
Debuggable::Debuggable(bool debugEnable) :
    _debugEnabled(debugEnable)
{}

void Debuggable::useDebug(bool debugEnable) {
    _debugEnabled = debugEnable;
}

void Debuggable::_printDebug(const std::string& msg) {
    if (_debugEnabled) {
